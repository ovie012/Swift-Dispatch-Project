                    ...
                    <div className='track-map-container'>
                        ...
                        <div className="track-showing">
                            ...
                            <div className="span-image-horizontal">
                                <img src="/RTT--DT-Icon-Pickup-Box.svg" alt="item packaged icon" />
                                <span></span>
                                <img src="/RTT--DT-Icon-Delivery-Truck.svg" alt="delivery truck icon" />
                                <span></span>
                                <img src="/RTT--DT-Icon-Delivered-Check-Box.svg" alt="item delivered icon" />
                            </div>
                            <h5>Destination</h5>
                                ...
                                <div>
                                    <section>
                                        ...
                                        <section className='last-update-location'>
                                            <p>House 20, Park View Estate, <br />
                                            Lekki, Lagos.</p>
                                            <p>May 27 <br />
                                            <aside>12:00</aside></p>
                                        </section>
