      ...
      <main>
          ...
          <div className="package-time">
            <div className="package-time-text">
              ...
              <div className="text-with-img">
                <div>
                  <img
                    src="/LP--H-Icon-Bike-Secured-&-Swift.svg"
                ...
                <div>
                  <img
                    src="/LP--H-Icon-GPS-Real-Time.svg"
        ...
        <div className="swift-coverage">
          <div className="swift-coverage-container">
            <div>
              <img
                src="/LP--VP-Icon-Parcel-Delivered.svg"
            ...
            <div>
              <img
                src="/LP--VP-Icon-Total-Distance-Covered.svg"
                alt="location icon"
              />
              <h4>45KM</h4>
              <p>
                Total Distance <span>Covered</span>
              </p>
            </div>
            <div>
        ...
        <div className="swift-package">
          <div className="boxed-package">
            <div>
              <img
                src="/LP--VP-Icon-Customer-Support.svg"
            ...
            <div>
              <img
                src="/LP--VP-Icon-Order-Management.svg"
            ...
            <div>
              <img
                src="/LP--VP-Icon-Real-Time-Tracking.svg"
                alt="location icon"
              />
              <h4>Real-Time Tracking</h4>
              <p>
          ...
          <div className="services">
            ...
            <div className="services-img">
              ...
              <div className="services-img-icons">
                ...
                <div>
                  <img
                    src="/LP--SER-Icon-Perishable.svg"
                    alt="delivered icon"
                  />
                  <h4>
                    Perishable <br />
