                    ...
                    <div className="fill-form-container sm:bg-[#DCFFFC] py-[20px] sm:py-[50px] px-[20px] rounded-2xl">
                        ...
                        <div className="second-form">
                            <form action="post">
                                ...
                                <textarea name="message" id="message" rows={4} placeholder="Describe how big and wide the package is. state if the package is fragile and what is in the package."></textarea>
                            </form>
                        </div>
                        ...
                        <div className="delivery">
                            ...
                            <div className="delivery-service">
                                <div>
                                    <img src="/PS--Icon-Delivery-Truck.svg" alt="delivery truck" />
                                    <section>
